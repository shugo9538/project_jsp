	...
	<c:choose>
		<c:when test="${sessionScope.vo != null}">
			...
			<section class="edit_info">
				<form class="editForm" name="editForm" action="editInfoAction.gu" method="post" onsubmit="return editFormCheck();">
					<legned>
					<h1>회원정보 수정</h1>
					<hr>
					</legned>
					<fieldset>
						<table>
							...
							<tr>
								<td>휴대폰 번호</td>
								<td>
									<input type="text" id="reTel" name="reTel" value="${sessionScope.vo.getTel()}" maxlength="11"
										onkeyup="editTelCheck()"
									>
							...
							<tr>
								...
								<td>
									<div class="checkBoxForm">
										<div>
											<input type="checkbox" id="checkAlert" name="checkAlert" value="${(sessionScope.vo.isAlertChk()) ? 1 : 2}"
